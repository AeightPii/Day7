...
class FavBikeDB(context: Context?) :
    SQLiteOpenHelper(
        context,
        DATABASE_NAME, null,
        DB_VERSION
...
//        cv.put(ITEM_NUMBER, item_number)
//        cv.put(ITEM_COLOR, item_color)
//        cv.put(ITEM_MODEL, item_model)
...
//                    + ITEM_IMAGE + " TEXT," + FAVORITE_STATUS + " TEXT," + ITEM_NUMBER + " TEXT,"
//                    + ITEM_COLOR + " TEXT," + ITEM_MODEL + " TEXT," + ITEM_PRICE + " TEXT,"
