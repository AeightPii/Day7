...
class BikeAdapter(
    bikeItems: List<BikeX>,
    context: Context
) : RecyclerView.Adapter<BikeAdapter.ViewHolder>() {

    private var bikeItems: List<BikeX> = listOf()
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val bikeItem: BikeX = bikeItems[position]
...
//        }
    ...
    interface ClickListener {
        fun onClick(id: BikeX)//no implementation no body
    }

    private fun likeClick(bikeItem: BikeX, favBtn: Button) {
        val refLike =
...
//                    bikeItem.description,
    ...
    private fun readCursorData(
        bikeItem: BikeX, viewHolder: ViewHolder
    ) {
    ...
    fun updateList(result: List<BikeX>) {
